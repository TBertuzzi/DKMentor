# DK Mentor 3.3.1 Test r1 - Guidance Source Audit

**Reviewed:** 2026-09-11  
**Live patch target:** 12.1.0  
**Retail Interface:** 120100  
**Baseline reviewed:** published 3.3.0 / Source r11
...
12.1.5 is still presented by Blizzard as the upcoming/PTR content update during this review window. DK Mentor remains targeted at live **12.1.0 / Interface 120100** for 3.3.1.
...
## Unholy consumables refresh - changed in 3.3.1
...
The published 3.3.0 baseline followed the heading and marked Disease/San'layn Recommended. 3.3.1 uses the more specific explanatory comparison:
...
## Valeera audit - changed in 3.3.1
...
- `Localization.lua`
- `scripts/validate.py`
- `tests/guidance_refresh_331_smoke.lua`
...
Use **3.3.1 Test r1** for in-game verification, then publish it as **3.3.1** if the live-client checks pass. This is a guidance/data refresh, not a 3.4.0 feature release. Use `Version: 3.3.1`, `Interface: 120100`, and live patch metadata `12.1.0`.
