...
$Files = @("DKMentor.toc","Localization.lua","Data.lua","Builds.lua","Guides.lua","GearData.lua","Codex.lua","Voices.lua","Core.lua","MentorEngine.lua","MentorReview.lua","DKTools.lua","MentorStudio.lua","LICENSE","THIRD_PARTY_NOTICES.md")
