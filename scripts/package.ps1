...
$Files = @("DKMentor.toc","Localization.lua","Data.lua","Builds.lua","Guides.lua","GearData.lua","PreparationData.lua","AdvisorData.lua","ValeeraData.lua","Codex.lua","Voices.lua","Core.lua","Advisor.lua","Valeera.lua","MentorEngine.lua","MentorReview.lua","DKTools.lua","MentorStudio.lua","LICENSE","THIRD_PARTY_NOTICES.md")
