...
assert(DKM.GearData.reviewed == "2026-09-06", "Gear review date mismatch")
assert(DKM.GearData.specs[251].sourceUpdated == "2026-09-02", "Frost gear source date mismatch")
assert(DKM.GearData.specs[252].sourceUpdated == "2026-09-05", "Unholy gear source date mismatch")
