...
assert(data.reviewed == "2026-09-01", "PreparationData review date mismatch")
...
assert(hasItem(data.specs[250].gems, 240906), "Blood Quick Garnet San'layn alternative missing")
